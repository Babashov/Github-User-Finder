...
return(
    <>
        <div className="w-full mx-auto lg:w-10/12">
                ...
                <div className="col-span-2">
                    <div className="mb-6">
                        ...
                        <div className="mt-4 card-actions">
                            <a href={html_url} target="_blank" rel='noreferrer' className="btn btn-outline">Github Profile</a>
                        </div>
                    </div>
            ...
            <div className="w-100 py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
                <div className="stat">
